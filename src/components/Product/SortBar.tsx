...
export const SortBar: React.FC<SortBarProps> = ({
    ...
    return (
        <div className="flex flex-col sm:flex-row justify-between items-center p-4 md:px-8 bg-green-50 gap-4">
            ...
            <button className="px-3 py-2 rounded-full bg-[#1D7B3C] text-white text-sm font-light hover:bg-[#20571E] transition flex gap-2 sm:hidden">
            ...
            <div className="flex items-center gap-2">
                <span className="text-[#808080] text-sm">Sort by:</span>
