            ...
            >
                ...
                <div className="flex flex-col space-y-6 p-6 text-lg">
                    <Link
                        to="/"
                        onClick={() => setIsOpen(false)}
                        className="hover:text-[#20571E] text-[25px] font-bold text-[#121212] border-b-[0.5px] border-[#D9DBE9]"
                    >
                        Home
                    </Link>
                    <Link
                    ...
                    >
                        <div className="relative">
                            <img src={cartnav} alt="cart" />
                            {cartCount > 0 && (
                                <span className="absolute -top-2 -right-2 bg-[#1D7B3C] text-white text-xs rounded-full px-1.5 min-w-[20px] text-center">
                                    {cartCount}
                                </span>
                            )}
                        </div>
