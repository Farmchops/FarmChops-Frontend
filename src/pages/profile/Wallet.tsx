    ...
    <div className="py-6">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mt-6">
        ...
        >
          ...
          <span className="text-sm font-medium text-gray-700">Pay-for-Me</span>
        </button>
        ...
        >
          ...
          <span className="text-sm font-medium text-gray-700">Create Link</span>
        </button>
      </div>
      ...
      <div className="mt-8 bg-blue-50 border border-blue-100 rounded-xl p-4">
        <h3 className="font-medium text-blue-900 mb-1">Pay-for-Me Feature</h3>
        <p className="text-sm text-blue-700">
          Create payment links and share with friends or family to help pay for your orders.
